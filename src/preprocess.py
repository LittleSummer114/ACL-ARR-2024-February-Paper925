...
from src.data_utils import get_dep_con
import copy
...
class Preprocessor:
    def __init__(self, config):
        ...
        # TODO: 添加roberta-large 虽然zh不是roberta但是这里后续也没用到,en也没用到
    ...
    def read_data(self, mode):
        ...
        # with open(
        #         "/nfs/home/yangliu/code/nlp/jn/secondary/project-DiaASQ/project/data/dataset/jsons_zh/zh_{}_subword.json".format(
        #                 mode), 'w', encoding='utf-8') as f:
        #     json.dump(dididu, f, indent=4, ensure_ascii=False)
        # dididu.clear()
    ...
    def transform2indices(self, dataset, mode='train'):
        ...
        for document in dataset:
            ...
            reply_mask, speaker_masks, thread_masks = self.get_neighbor(utterance_spans, orginal_replies,
                                                                        sum(sentence_length), speakers, thread_nums)
